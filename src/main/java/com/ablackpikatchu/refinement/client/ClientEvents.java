...
import com.ablackpikatchu.refinement.client.render.ter.EnergyTransmitterTER;
...
import com.ablackpikatchu.refinement.client.screen.tileentity.EnergyTransmitterScreen;
...
public class ClientEvents {
	...
	public static void clientSetup(FMLClientSetupEvent event) {
		...
		ScreenManager.register(ENERGY_TRANSMITTER_CONTAINER_TYPE.get(), EnergyTransmitterScreen::new);
		...
		ClientRegistry.bindTileEntityRenderer(TileEntityTypesInit.STORAGE_BIN_TILE_ENTITY_TYPE.get(),
				StorageBinTER::new);
		ClientRegistry.bindTileEntityRenderer(TileEntityTypesInit.ENERGY_TRANSMITTER_TILE_ENTITY_TYPE.get(), EnergyTransmitterTER::new);
	}

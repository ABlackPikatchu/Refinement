...
public class MCMathUtils {
	...
	/**
	 * Distance between two {@link Vector3i} (such as
	 * {@link net.minecraft.util.math.BlockPos}). Consider using {@link #distanceSq}
	 * when possible.
	 *
	...
	/**
	 * Distance between two {@link IPosition}. Consider using {@link #distanceSq}
	 * when possible.
	 *
	 * @param from One point
	 * @param to   Another point
	...
	/**
	 * Distance squared between two {@link Vector3i} (such as
	 * {@link net.minecraft.util.math.BlockPos}). Use instead of {@link #distance}
	 * when possible.
	 *
	 * @param from One point
	 * @param to   Another point
	...
	/**
	 * Distance squared between two {@link IPosition}. Use instead of
	 * {@link #distance} when possible.
	 *
	 * @param from One point
	 * @param to   Another point
	 * @return The distance between {@code from} and {@code to} squared
	 ...
	 * Consider using {@link #distanceHorizontalSq} when possible.
	 *
	 * @param from One point
	 * @param to   Another point
	 * @return The distance between {@code from} and {@code to} squared, ignoring
	 *         Y-axis
	 */
	...
	/**
	 * Distance between two {@link IPosition}, but ignores the Y-coordinate.
	 * Consider using {@link #distanceHorizontalSq} when possible.
	 *
	 * @param from One point
	 * @param to   Another point
	...
	/**
	 * Distance between an entity's position and a given position, but ignores the
	 * Y-coordinate.
	 *
	 * @param entity The entity
	 * @param pos    The other point
	...
	/**
	 * Distance squared between two {@link Vector3i} (such as
	 * {@link net.minecraft.util.math.BlockPos}), but ignores the Y-coordinate. Use
	 * instead of {@link #distanceHorizontal} when possible.
	 *
	 * @param from One point
	 * @param to   Another point
	 * @return The distance between {@code from} and {@code to} squared, ignoring
	...
	/**
	 * Distance squared between two {@link IPosition}, but ignores the Y-coordinate.
	 * Use instead of {@link #distanceHorizontal} when possible.
	 *
	 * @param from One point
	 * @param to   Another point
	 * @return The distance between {@code from} and {@code to} squared, ignoring
	...
	/**
	 * Distance squared between an entity's position and a given position, but
	 * ignores the Y-coordinate.
	 *
	 * @param entity The entity
	 * @param pos    The other point
	 * @return The distance between {code entity} and {@code pos} squared, ignoring
	 *         Y-axis
	 */

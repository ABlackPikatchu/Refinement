...
public class TextFormattingUtils {
	...
	public static TranslationTextComponent italicTranslationTextComponent(TranslationTextComponent text, boolean apply) {
		return (TranslationTextComponent) text.setStyle(Style.EMPTY.withItalic(apply));
	}
	
	public static TranslationTextComponent underlineTranslationTextComponent(TranslationTextComponent text, boolean apply) {
		return (TranslationTextComponent) text.setStyle(Style.EMPTY.setUnderlined(apply));
	}
	
	public static TranslationTextComponent strikethroughTranslationTextComponent(TranslationTextComponent text, boolean apply) {

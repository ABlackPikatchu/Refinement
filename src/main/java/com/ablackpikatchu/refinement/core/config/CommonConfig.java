...
public class CommonConfig {
    ...
    // Energy Generator
    public static final ForgeConfigSpec.ConfigValue<Integer> ENERGY_GENERATOR_FUEL_LASTING;
    public static final ForgeConfigSpec.ConfigValue<Integer> ENERGY_GENERATOR_ENERGY_MADE;
    ...
    static {
        ...
        ENERGY_GENERATOR_FUEL_LASTING = BUILDER.comment("The lasting of fuel in the Energy Generator, int ticks. (With no speed upgrades) (Default value is 200)").define("Default Process Time", 200);
        ENERGY_GENERATOR_ENERGY_MADE = BUILDER.comment("The energy made by the Energy Generator (per tick)").define("Energy Made", 50);

...
public class EnergyGeneratorBlock extends Block {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return TileEntityTypesInit.ENERGY_GENERATOR_TILE_ENTITY_TYPE.get().create();
    }
    ...
    public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity player,
        ...
        if (!worldIn.isClientSide()) {
            ...
            if (te instanceof EnergyGeneratorTileEntity) {
                NetworkHooks.openGui((ServerPlayerEntity) player, (EnergyGeneratorTileEntity) te, pos);
            }
        }
    ...
    public void setPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer,
        ...
        if (stack.hasCustomHoverName()) {
            ...
            if (tile instanceof EnergyGeneratorTileEntity) {
                ((EnergyGeneratorTileEntity) tile).setCustomName(stack.getDisplayName());
            }
        }
    }

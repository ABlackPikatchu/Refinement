...
public class AnvilRecipeCategory implements IRecipeCategory<AnvilRecipe> {
	...
	public static final ResourceLocation ID = new ResourceLocation(Refinement.MOD_ID, ".anvil_recipe_category");
	...
	public String getTitle() {
		return new TranslationTextComponent("category." + Refinement.MOD_ID + ".anvil").getString();
	}
